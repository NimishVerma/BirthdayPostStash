    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('unique_uuid', models.UUIDField(db_index=True, default=uuid.uuid4, unique=True)),
                ...
                ('is_active', models.BooleanField(db_index=True, default=False, help_text='Designates whether this user             should be treated as active.             Unselect this instead of deleting accounts.', verbose_name='active')),
